...
const StepIndicator = () => {
    return (
        <ol className="flex items-center w-full ml-10">
            <li className="flex w-full items-center text-ㅡmain dark:text-main after:content-[''] after:w-full after:h-1 after:border-b after:border-gray-100 after:border-4 after:inline-block dark:after:border-gray-700">
